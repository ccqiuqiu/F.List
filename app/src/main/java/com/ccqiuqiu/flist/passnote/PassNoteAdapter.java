...
class PassNoteAdapter
        extends RecyclerView.Adapter<PassNoteAdapter.MyViewHolder>
        implements DraggableItemAdapter<PassNoteAdapter.MyViewHolder>,
        SwipeableItemAdapter<PassNoteAdapter.MyViewHolder> {
    ...
    //构造方法
    public PassNoteAdapter(BaseDataProvider dataProvider, MainActivity mainActivity) {
    ...
    public void onBindViewHolder(MyViewHolder holder, int position) {
        ...
        PassNote note = (PassNote) item.getmEntity();
        // set text
        //holder.mTextView.setText(AESUtils.decode(note.getTitle(),App.key));
        holder.mTextView.setText(note.getTitle());
        holder.mDragHandle.setImageResource(R.drawable.ic_account);
        holder.mDragHandle.setColorFilter(App.colorPrimary);
...
//                item.isPinned() ? Swipeable.OUTSIDE_OF_THE_WINDOW_LEFT : 0);
    ...
    public int onGetSwipeReactionType(MyViewHolder holder, int position, int x, int y) {
        if (onCheckCanStartDrag(holder, position, x, y)) {
            ...
            return Swipeable.REACTION_CAN_NOT_SWIPE_RIGHT;
        } else {
...
//                }
    ...
    private static class SwipeLeftResultAction extends SwipeResultActionMoveToSwipedDirection {
        private PassNoteAdapter mAdapter;
        private final int mPosition;
        private boolean mSetPinned;
        private MyViewHolder mHolder;

        SwipeLeftResultAction(PassNoteAdapter adapter, int position,MyViewHolder holder) {
            mAdapter = adapter;
            mPosition = position;
            mHolder = holder;
        }
...
//            mAdapter.notifyItemChanged(mPosition);
    ...
    private static class SwipeRightResultAction extends SwipeResultActionRemoveItem {
        ...
        SwipeRightResultAction(PassNoteAdapter adapter, int position) {
            mAdapter = adapter;
            mPosition = position;
        }
    ...
    private static class UnpinResultAction extends SwipeResultActionDefault {
        ...
        UnpinResultAction(PassNoteAdapter adapter, int position) {
            mAdapter = adapter;
            mPosition = position;
        }
